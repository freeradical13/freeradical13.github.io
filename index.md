...
An [operator][] is a part of a promoter which, if bound to by a [repressor][] protein (generated by the associated regulatory gene), inactivates the promoter of the rest of the gene(s) which is called the [operon][]. A molecule called a [corepressor][] binds to the repressor to activate it to bind to the operator.
