...
[Some vertebrate animals][animal adaptive immune system] include an [adaptive immune system][] (or acquired immune system, or specific immune system) which is in addition to the innate immune system and uses specialized cells for more targeted defense against pathogens.
...
* [Lymphocytes][] (Lymphoid) are leukyoctes found predominantly in lymph. This cell type may further specialize into:
  ...
  * A precursor cell which may further specialize into:
    ...
    * A T cell which is in the adaptive immune system and may further specialize into:
...
1. TLR1 recognizes lipopeptides on some bacteria.
1. TLR2 recognizes glycosylphosphatidylinositol and lipoteichoic acid on some parasites and gram-positive bacteria.
...
1. TLR6 recognizes zymosan on some fungi.
1. TLR7 recognizes some single-stranded viral RNAs.
1. TLR8 recognizes some single-stranded viral RNAs.
1. TLR9 recognizes unmethylated CpG nucleotide motifs on some bacterial and viral genomes but not in human DNA.
...
The coating of a pathogen with markers such as C3 is called [opsonization][] and alllows phagocytes to process the pathogen using receptors such as [Complement Receptor 1][] (CR1), [Complement Receptor 3][] (CR3), and [Complement Receptor 4][] (CR4).

C3b may also create a [C5 convertase][] which cleaves [C5][] into small C5a and large C5b fragments. C5b interacts with C6, C7, C8, and C9 to create a [membrane-attack complex][] which makes holes in cell membranes that cause cell lysis (known to be particularly effective strains of <i>[Neisseria][]</i> that cause gonorrhea and one form of bacterial meningitis). As with Factor H, Factor I, DAF, and MCP, there are proteins that act to inhibit the membrane-attack complex on human cells: [Protein S][], [Clusterin][], Factor J, Homologous Restriction Factor (HRF), and [Protectin][] (CD59). The disease [paroxysmal nocturnal hemoglobinuria][] is the inability to link DAF, HRF, and CD59 to the plasme membrane with glycosyl phosphatidylinositols.
...
The alternative pathway may be activated by the binding of C-reactive protein to a pathogen which then interacts with [C1 complex][] which leads to C4 and C2 cleavage that create C3 convertase.

The Lectin pathway may be activated by [Mannose-Binding Lectin][] which may bind to certain conformations of mannose on pathogens and may ultimately lead to a C3 convertase.
...
[T cells][] mature in the lymphatic system organ called the [thymus][] and bind to antigens on host cells called [antigen-presenting cells][] (such as dendritic cells) that present antigens connected to [Major Histocompatibility Complex][] (MHC) molecules. A T cell paratope is a protein made of two polypeptide chains (called the α chain and β chain) anchored into the T cell membrane and linked with a disulfide bridge. Each chain also has a constant region and variable region and the pair of chains are the paratope.

[Cytotoxic T cells][] are like specialized Natural Killer Cells and use a protein called [CD8][] on the cytotoxic T cell surface to detect class I MHC molecules along with an antigen on infected cells. After binding, the cytotoxic T cell secretes proteins such as [Perforin][] and [Granzymes][] that stimulate apoptosis of matching cells.
...
[c5]: https://en.wikipedia.org/wiki/Complement_component_5
[c5 convertase]: https://en.wikipedia.org/wiki/C5-convertase
...
[clusterin]: https://en.wikipedia.org/wiki/Clusterin
...
[complement receptor 1]: https://en.wikipedia.org/wiki/Complement_receptor_1
[complement receptor 3]: https://en.wikipedia.org/wiki/Complement_receptor_3
[complement receptor 4]: https://en.wikipedia.org/wiki/Complement_receptor_4
...
[mannose-binding lectin]: https://en.wikipedia.org/wiki/Mannan-binding_lectin
...
[neutralization]: https://en.wikipedia.org/wiki/Neutralisation_(immunology)
...
[phagolysosome]: https://en.wikipedia.org/wiki/Phagolysosome
[phagosome]: https://en.wikipedia.org/wiki/Phagosome
...
[protectin]: https://en.wikipedia.org/wiki/CD59
...
[protein s]: https://en.wikipedia.org/wiki/Protein_S
...
[regulatory t cells]: https://en.wikipedia.org/wiki/Regulatory_T_cell
...
[rig-i-like receptors]: https://en.wikipedia.org/wiki/RIG-I-like_receptor
