...
[Ribosomes][] are not organelles but are structures in the cytoplasm involved in protein synthesis. Ribosomes are made of various proteins and RNA called ribosomal RNA ([rRNA][]).

If a protein is planned to be [secreted][protein secretion] through the cell membrane, a [signal recognition particle][] (or SRP), which is a protein-RNA complex, binds to a short chain of amino acids at the N-terminus of the protein called the [signal peptide][] as it is being generated by the ribosome. The SRP binding pauses translation and allows for the process to move to and finish at the endoplasmic reticulum.
